...
\medskip \noindent {\bf (88.12)}\ Evaluate the Fresnel integrals
\begin{equation*}
...
\end{proof}
\medskip \noindent {\bf (92.1)}\ Show that $\int_0^{2\pi} \frac{d\theta}{5 + 4 \sin \theta} = 2\pi/3.$
\begin{proof}
	...
	\end{equation*}
\end{proof}
\medskip \noindent {\bf (92.6)}\ Show that $\int_0^\pi \sin^{2n}(\theta)\ d\theta = \frac{(2n)!}{2^{2n}(n!)^2} \pi$.
\begin{proof}
	...
	\end{equation*}
\end{proof}
\medskip \noindent {\bf (95.1)}\ Find the inverse Laplace transfor of
\begin{equation*}
	F(s) = \frac{2s^3}{s^4 -4}.
\end{equation*}
